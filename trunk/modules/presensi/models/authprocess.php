...
class Authprocess extends CI_Model
{
    ...
    function getAllRecords($offset='',$paging=''){
        ...
        $this->db->select('UserID,Name,CONVERT(VARCHAR(10),ProcessDateStart, 105) as MyDate,CONVERT(VARCHAR(8),ProcessDateStart, 108) AS MyTimeStart,CONVERT(VARCHAR(8),ProcessDateEnd, 108) AS MyTimeEnd');
