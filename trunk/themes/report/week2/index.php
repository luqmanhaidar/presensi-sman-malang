	...
	<?php 
        ...
        foreach($users as $row):?>
			<tr>
                ...
                <td><?='';?></td>
				<td class="center"><?=numericToTime($this->authprocess->getWeekDuration(1,$row['ID']))?></td>
				<td class="center"><?=numericToTime($this->authprocess->getWeekDuration(2,$row['ID']))?></td>
				<td class="center"><?=numericToTime($this->authprocess->getWeekDuration(3,$row['ID']))?></td>
				<td class="center"><?=numericToTime($this->authprocess->getWeekDuration(4,$row['ID']))?></td>
				<td class="center"><?=numericToTime($this->authprocess->getWeekDuration(5,$row['ID']))?></td>
				<td></td>
				<td></td>
			</tr>
     <?php 
